...
namespace AltEevee.UpgradesJohto
{
    public class SharperPinsJohto : ModUpgrade<AltEevee.EeveeJohto>
    { 
    ...
    public class HarderPinsJohto : ModUpgrade<AltEevee.EeveeJohto>
    {
        public override int Path => TOP;
    ...
    public class FasterThrowingJohto : ModUpgrade<AltEevee.EeveeJohto>
    {
    ...
    public class FasterPinsJohto : ModUpgrade<AltEevee.EeveeJohto>
    {
        public override int Path => MIDDLE;
        public override int Tier => 2;
    ...
    public class LongRangePinsJohto : ModUpgrade<AltEevee.EeveeJohto>
    {
    ...
    public class LongerRangePinsJohto : ModUpgrade<AltEevee.EeveeJohto>
    {
        public override int Path => BOTTOM;
        public override int Tier => 2;

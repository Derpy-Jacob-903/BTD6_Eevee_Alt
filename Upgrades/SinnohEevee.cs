...
namespace AltEevee.UpgradesSinnoh
{
    public class SharperPinsSinnoh : ModUpgrade<AltEevee.EeveeSinnoh>
    { 
    ...
    public class HarderPinsSinnoh : ModUpgrade<AltEevee.EeveeSinnoh>
    {
        public override int Path => TOP;
    ...
    public class FasterThrowingSinnoh : ModUpgrade<AltEevee.EeveeSinnoh>
    {
    ...
    public class FasterPinsSinnoh : ModUpgrade<AltEevee.EeveeSinnoh>
    {
        public override int Path => MIDDLE;
        public override int Tier => 2;
    ...
    public class LongRangePinsSinnoh : ModUpgrade<AltEevee.EeveeSinnoh>
    {
    ...
    public class LongerRangePinsSinnoh : ModUpgrade<AltEevee.EeveeSinnoh>
    {
        public override int Path => BOTTOM;
        public override int Tier => 2;
